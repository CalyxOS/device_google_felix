...
VENDOR_SKIP_FILES=(
    ...
    "bin/hw/android.hardware.qorvo.uwb.service"
    ...
    "etc/init/qorvo.uwb-calib.rc"
    "etc/init/qorvo.uwb-service.rc"
    ...
    "etc/vintf/manifest/qorvo.uwb-service.xml"
    ...
    "lib/libqorvo_uwb_params_nfcc.so"
    ...
    "lib64/libqorvo_uwb_params_nfcc.so"
